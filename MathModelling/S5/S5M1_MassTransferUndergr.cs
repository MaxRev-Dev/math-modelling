...
namespace MM.S5
{
    internal class S5M1_MassTransferUndergr : BaseMethod
    {
        [ReflectedUICoefs]
        ...
        public override double[][] Calculate()
        {
            ...
            Func<double, double> cx0 = x =>
                N - 6 + Math.Pow(Math.Sin(N * x * h), 2);
            Func<double, double> c0t = t => 0;
            Func<double, double> clt = i =>
                N - 6 + Math.Pow(Math.Sin(N * l), 2) + 0.2;
